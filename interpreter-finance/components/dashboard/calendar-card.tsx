  ...
  return (
    <Glass className="p-5">
      <div className="flex items-center justify-between">
        ...
        <div className="group/legend flex flex-col items-start gap-1 text-[10px] text-muted-foreground">
          <div className="flex items-center gap-1.5"><CheckCircle2 className="size-3 text-green-500" /> <span className="opacity-0 group-hover/legend:opacity-100 transition-opacity duration-200">goal met</span></div>
          <div className="flex items-center gap-1.5"><X className="size-3 text-red-500" /> <span className="opacity-0 group-hover/legend:opacity-100 transition-opacity duration-200">failed goal</span></div>
        </div>
      </div>
