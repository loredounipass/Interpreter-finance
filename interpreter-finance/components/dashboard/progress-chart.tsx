...
export function ProgressChart({ data }: { data: ChartPoint[] }) {
  ...
  return (
    <div className="h-[180px] w-full" aria-label="Daily interpretation minutes chart" role="img">
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 10, right: 4, left: -18, bottom: 0 }}>
          ...
          <YAxis orientation="right" tickLine={false} axisLine={false} tick={{ fill: 'var(--muted-foreground)', fontSize: 11 }} domain={[0, yMax]} />
